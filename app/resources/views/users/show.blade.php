  ...
  <div class="breadcrumbbar">
    <div class="row align-items-center">
      ...
      <div class="col-md-4 col-lg-4">
        <div class="widgetbar">
          <button class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit Account Settings</button>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="card m-b-30">
              ...
              <div class="card-body pb-0">
                <div class="chat-detail mb-0">
                  <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 440px;"><div class="chat-body" style="overflow: hidden; width: auto; height: 440px;">
                  ...
                  </div><div class="slimScrollBar" style="background: rgb(207, 216, 220); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
