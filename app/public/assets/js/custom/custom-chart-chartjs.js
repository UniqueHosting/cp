    ...
    var lineDiffPoint = new Chart(lineDiffPointID, {
        ...
        data: {
            ...
            datasets: [{
                ...
                pointBackgroundColor: ["#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6"],
                fill: false,
                borderDash: [5, 5],
                pointRadius: 15,
                pointHoverRadius: 20,
        ...
        var lineChart = new Chart(linechartID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["#3B82F6"],
                    borderColor: ["#3B82F6"],
                    pointBorderColor: ["#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6"],
        ...
        var scatterChart = new Chart(scatterChartID, {
            ...
            data: {
                datasets: [{
                    ...
                    pointBorderColor: ["#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6"],
            ...
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        ...
                        borderColor: ["#3B82F6", "#3B82F6", "#3B82F6", "#3B82F6", "#3B82F6", "#3B82F6", "#3B82F6"],
                        borderWidth: 1,
        ...
        var multiAxisBarChart = new Chart(multiAxisBarChartID, {
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Series A',
                        backgroundColor: ["#3B82F6","#43d187","#f2f3f7","#f9616d","#f7bb4d","#3d9bfb","#141d46"],
                        yAxisID: 'y-axis-1',
        ...
        var datasetArea = new Chart(datasetAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["rgba(80,111,228,0.5)"],
                    borderColor: ["#3B82F6"],
                    pointBorderColor: ["#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2,                                               
        ...
        var radarArea = new Chart(radarAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderColor: ["#3B82F6"],
                    pointBorderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBackgroundColor: ["#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6","#3B82F6"],
                    pointBorderWidth: 1,
        ...
        var doughnutChart = new Chart(doughnutChartID, {
            ...
            data: {
                datasets: [{
                    ...
                    backgroundColor: ["#3B82F6","#43d187","#f2f3f7"],
                    label: 'Dataset 1'
                }],
